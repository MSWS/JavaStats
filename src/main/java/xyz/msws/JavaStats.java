...
public class JavaStats extends TimerTask {
    ...
    private static String metaContent = """
            ...
            <meta content="EdgeGamers Stats" property="og:title" />
            <meta content="EGO Stats Auto-Generated by MSWS" property="og:description" />
            <meta content="http://egostats.msws.xyz/" property="og:url" />
            <meta content="https://msws.xyz/logo" property="og:image" />
    ...
    public String run(long time) {
        ...
        str = String.format("<html><head>" + metaContent + "</head><body><p>%s</p></body></html>", str);
        return str;
    }
}
